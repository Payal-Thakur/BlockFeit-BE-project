...
contract BlockFeit {
    ...
    */
    function addManufacturer(string memory _manufacturer, string memory _location, string memory _brand) public {
    ...
    */
    ...
    function sellProductsToRetailer (string memory _id, uint _quantity)  public returns(string memory) {
    ...
    */
    function sellProductToCustomer(string memory _seller_id, string memory _customer_id) public {
        ...
        for(uint i = 0; i < tempRetailer.available.length-1; i++) {
    ...
    */
    function getProductDetail(string memory _product_id) public view returns(
                                string memory, string memory, 
                                string memory, string memory, 
                                string memory, string memory, string memory) {

            return(productMapping[_product_id].id, 
    ...
    */
    function getRetailerProductCount(string memory _retailer_id) public view returns(uint) {
    ...
    */
    function getCustomerProductCount(string memory _customer_id) public view returns(uint) {
    ...
    */
    function getRetailerDetails(string memory retailer_id) public view returns(string memory, string memory,
     string memory, string memory, string memory, uint) {

        return(retailers[retailer_id].id,
   ...
   function getOwnerOfProduct(string memory product_id) public view returns(string memory, string memory) {

        return(productMapping[product_id].name, productMapping[product_id].ownwer);
    }
    ...
    */
    function verifyOwnership(string memory product_id, string memory owner_id) public view returns(bool) {

        return(keccak256(bytes(productMapping[product_id].ownwer)) == keccak256(bytes(owner_id)));
    }
