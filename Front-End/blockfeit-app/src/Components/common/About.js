                ...
                <div class="container">
                  <div class="row-10 col-30">
                    <div class="w3-panel w3-padding-16">
                      ...
                      <div class="h4">
                        <h4>
                          In order to ensure the identification and
                          trace-ability of genuine products throughout the
                          supply chain, we plan to implement a fully functional
                          block-chain application system to prevent product
                          counterfeiting.
                        </h4>
                        <br />

                        <h4>
                          We describe a Block-chain Web Application System with
                          products anti-counterfeiting with an additional smart
                          contract feature that enhances trust between the
