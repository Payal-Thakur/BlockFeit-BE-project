      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 shadow-sm px-4">
            ...
            <h5>The Product is Blockchain Verified.</h5>
            <h5 id="m1"> Congratulations !! </h5>
            <br></br>
            <h5>
              This guarantees that the product is geneuine & protects consumers
              against frauds.
            </h5>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="pd">
                    ...
                    <p>
                      Color: Blue Outer material: Textile Model name: Phosphere
                      Occasion: Sports Leather type: Napa Secondary color: White
