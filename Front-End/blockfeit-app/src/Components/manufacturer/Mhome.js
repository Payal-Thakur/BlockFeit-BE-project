      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-3">
            <div className="card custom-2">
              <div class="card-body ">
                <i class="fa fa-key fa-2x align-middle float-left"></i>
                  ...
                  <li>
                    ...
                    <div class="btn-group">
                      ...
                      <button
                        ...
                        data-copy="**************XSFAGGW1514514698164981**********"
                        title="Copy to clipboard"
                      >
                        <i class="fa fa-copy fa-2x align-middle float-left"></i>{" "}
                      </button>{" "}
                    </div>
                  </li>
        ...
        <div class="row">
          <div class="col-3">
            <div className="card custom-2">
              <div class="card-body ">
                <i class="fa fa-bars fa-2x align-middle float-left"></i>
